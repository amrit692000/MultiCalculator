...
@Composable
fun CalcDisplay(display : MutableState<String>){ Text(
    display.value, modifier = Modifier.height(50.dp).padding(5.dp).fillMaxWidth()
)

}
@Composable
fun <int> CalcNumericButton(number : int, display: MutableState<String>){
    Button(onClick =  { display.value += number }, Modifier.padding(4.dp)){
